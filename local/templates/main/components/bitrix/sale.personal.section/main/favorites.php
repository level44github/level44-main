...
$APPLICATION->AddChainItem(Loc::getMessage("SPS_CHAIN_FAVORITES"));

$APPLICATION->AddViewContent("personal.back-link", $arResult['SEF_FOLDER']);
$APPLICATION->AddViewContent("personal.navigation-title", Loc::getMessage('SPS_CHAIN_FAVORITES'));
?>
...
<div class="profile favorites-list">
    <div class="profile__title"><?= Loc::getMessage('SPS_CHAIN_FAVORITES') ?></div>
    <?
    global $arrFilter;
