	...
	window.JCCatalogElement.prototype = {
			...
			if (this.errorCode === 0)
			{
				...
				switch (this.productType)
				{
					...
					case 2: // set
						...
						break;
					case 3: // sku
						treeItems = this.obTree.querySelectorAll('label.btn');
		...
		selectOfferProp: function()
		{
			...
			if (target && target.hasAttribute('data-treevalue'))
			{
                ...
                rowItems = BX.findChildren(target.parentNode, {tagName: 'label', className: 'btn'}, false);
		...
		updateRow: function(intNumber, activeId, showId, canBuyId)
		{
			...
			{
				rowItems = lineContainer[intNumber].querySelectorAll('label.btn');
				for (i = 0; i < rowItems.length; i++)
				{
					...
					var showKeys = Object.keys(showId);

                    if (showId.length === 1 && showKeys.length && parseInt(showId[showKeys[0]]) === 0) {
