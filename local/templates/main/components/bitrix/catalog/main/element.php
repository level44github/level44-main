...
<div>
    <? if (!empty($addToYouLookProducts)) {
        global $addToYouLookProductsFilter;
        $addToYouLookProductsFilter = [
            "ID" => $addToYouLookProducts,
        ];
        ?>
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            "products_on_detail",
            [
                "FILTER_NAME"               => "addToYouLookProductsFilter",
                "IBLOCK_TYPE"               => $arParams["IBLOCK_TYPE"],
                "IBLOCK_ID"                 => $arParams["IBLOCK_ID"],
                "ELEMENT_SORT_FIELD"        => "ID",
                "ELEMENT_SORT_ORDER"        => $addToYouLookProducts,
                ...
                'BACKGROUND_IMAGE'             => '',
                'DISABLE_INIT_JS_IN_COMPONENT' => (isset($arParams['DISABLE_INIT_JS_IN_COMPONENT']) ? $arParams['DISABLE_INIT_JS_IN_COMPONENT'] : ''),
                'TITLE'                        => Loc::getMessage("ADD_TO_YOUR_LOOK"),
            ],
            $component
        );
    }
    ...
    if (!empty($recommendProducts)) {
        ?>
        <?
        global $recommendProductsFilter;
        $recommendProductsFilter = [
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            "products_on_detail",
            [
                "FILTER_NAME"               => "recommendProductsFilter",
                "IBLOCK_TYPE"               => $arParams["IBLOCK_TYPE"],
                "IBLOCK_ID"                 => $arParams["IBLOCK_ID"],
                "ELEMENT_SORT_FIELD"        => "ID",
                "ELEMENT_SORT_ORDER"        => $recommendProducts,
                "PROPERTY_CODE"             => (isset($arParams["LIST_PROPERTY_CODE"]) ? $arParams["LIST_PROPERTY_CODE"] : []),
                "PROPERTY_CODE_MOBILE"      => $arParams["LIST_PROPERTY_CODE_MOBILE"],
                "INCLUDE_SUBSECTIONS"       => $arParams["INCLUDE_SUBSECTIONS"],
                "BASKET_URL"                => $arParams["BASKET_URL"],
