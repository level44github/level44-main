...
class PreOrder
{
    ...
    public function getSubscribeButton()
    {
        ...
        $button = <<<BUTTONS
                        <button class="btn btn-outline-dark btn-block js-btn__add-basket product__add-basket-desktop js-open-subscribe"
...
BUTTONS;
    ...
    public function getAlreadySubscribedButton()
    {
        ...
        $button = <<<BUTTONS
            <span class="btn btn-outline-dark btn-block js-btn__add-basket product__add-basket-desktop disabled" type="submit">
